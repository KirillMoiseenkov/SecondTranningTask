...
public class NewtaskTestContainer extends TestContainer {

    public NewtaskTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/newtask/app.properties",
    ...
    public static class Common extends NewtaskTestContainer {

        public static final NewtaskTestContainer.Common INSTANCE = new NewtaskTestContainer.Common();
